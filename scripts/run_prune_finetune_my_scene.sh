...
# Appoint data path
data_path="data/my_scene/train"  # adjust it to your own dataset

# Only one dataset specified here, but you could run multiple
declare -a run_args=(
    "my_scene"  # use the name of your finetuning config
 )


# Prune percentages and corresponding decays, volume power
declare -a prune_percents=(0.4 0.5 0.6)  # use the prune percentage you want
declare -a prune_names=(40 50 60)  # 10x the prune percentage, used to name the output
...
# Adjust the learning rate as you like
